...
public class UIPanelInspector : UIRectEditor
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		{
			//----pat----
			if (mPanel.clipping != UIDrawCall.Clipping.AcePolygon) 
			{
			...
			else
			{
				...
				mPanel.acePolygon = EditorGUILayout.ObjectField("AcePolygon(Rect)", mPanel.acePolygon, typeof(AcePolygon), true) as AcePolygon;
